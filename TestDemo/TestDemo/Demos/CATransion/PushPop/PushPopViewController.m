...
- (void)openPage:(UIButton*)sendor{
    PushPopDetailViewController *detailPage = [[PushPopDetailViewController alloc]init];
    ...
    [self.navigationController pushViewController:detailPage animation:self.animationType flipPosition:self.flip];
